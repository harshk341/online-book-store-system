...
<body id="page-top">
  ...
  <main id="main-field">
    <?php
    // include pages based on query parameter
  ...
  <footer class=" py-5 bg-dark">
    ...
    <br>
    <div class="container">
      <div class="small text-center text-muted"><?php echo $_SESSION['system']['name'] ?> | This project is developed by Harsh Kumar</div>
    </div>
  </footer>
